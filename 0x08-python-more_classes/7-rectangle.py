...
customizable string representation, object deletion handling,
...
class Rectangle:
    ...
    handle object deletion, and count instances.  The string representation
    uses a customizable symbol.
    """
